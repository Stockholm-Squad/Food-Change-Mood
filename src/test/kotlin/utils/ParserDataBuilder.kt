...
const val mealAsString = "\"mixecan meal,137739,55,47892,2005-09-16\"," +
        "\"['60-minutes-or-less', 'time-to-make', 'course', 'main-ingredient'," +
        " 'cuisine', 'preparation', 'occasion', 'north-american', 'side-dishes', " +
        "'vegetables', 'mexican', 'easy', 'fall', 'holiday-event', 'vegetarian', 'winter', 'dietary'," +
        " 'christmas', 'seasonal', 'squash']\"" +
        ",\"[51.5, 0.0, 13.0, 0.0, 2.0, 0.0, 4.0]\",11," +
        "\"['make a choice and proceed with recipe', 'depending on size of squash , cut into half or fourths'," +
        " 'remove seeds', 'for spicy squash , drizzle olive oil or melted butter over each cut squash piece'," +
        " 'season with mexican seasoning mix ii', 'for sweet squash , drizzle melted honey , butter , grated piloncillo over each cut squash piece'," +
        " 'season with sweet mexican spice mix', 'bake at 350 degrees , again depending on size , for 40 minutes up to an hour , until a fork can easily pierce the skin'," +
...
val mealAsListOfStrings = listOf(
            "mixecan meal",
        "137739",
        "55",
        "47892",
...
val listOfMealsAsString = listOf(
